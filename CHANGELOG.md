...
- [#307](https://github.com/nf-core/rnavar/pull/307) - Fix VEP LoFTEE plugin configuration by removing hardcoded path; VEP auto-discovers plugins from its installation directory
