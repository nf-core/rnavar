...
**nf-core/rnavar** is a bioinformatics best-practice analysis pipeline for Nextflow RNA-Seq analysis pipeline, part of the nf-core community..
...
4. Start running your own analysis!
    ...
    ```console
    nextflow run nf-core/rnavar -profile <docker/singularity/podman/shifter/charliecloud/conda/institute> --input samplesheet.csv --genome GRCh37
    ```
...
nf-core/rnavar was originally written by Praveen Raj.
